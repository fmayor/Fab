function dev = genSingleZZBender_181002_2(param)
...
zzb1 = genZZBender_longArm_181002_2(param_singleZZB);
zzb2 = genZZBender_longArm_181002_2(param_singleZZB);
zzb2.mirror([0;0],[1;0]);
...
% add joints
r_j1 = Rect(d_tetherCenter2ZZEnd + param.w/2, 0, l_joint * 2, w_joint, 'base','center');
r_j1.layer = 'M1_MD'; %M1_Neg (changed on 20181106)
r_j2 = r_j1.copy();
