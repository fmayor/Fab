function [LNPEZ_ZNB_X_Row, L_ZNBX] = genLNPEZ_ZNB_X_botrow_181202()
...
paramsZNBX2 = genParamStructs('L',[5,10,14,10,5,14],'d_nb2refl', [2.3,2.2,2.1],'L2',0,'g',0.3,...
    'w',0.45,'g_metal',0.15);
