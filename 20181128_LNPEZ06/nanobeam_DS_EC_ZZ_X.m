...
%         w_tetherArm = 30;   % mvoed to obj.P_tether as a parameter
        if obj.P_1DPS.isGen
            ...
            rect_TLR = Rect(x_posR2,y_posL2,w_rect_sub,h_rect_sub2, 'base','center');
            rect_TLR.layer = obj.layer_medium; 
            rect_TLR2 = Rect(x_posR2,y_pos3,w_rect_sub,h_rect_sub3, 'base','center');
        ...
        rect_BLR = Rect(x_posR2,-y_posL2,w_rect_sub,h_rect_sub2, 'base','center');
        rect_BLR.layer = obj.layer_medium; 
        rect_BLR2 = Rect(x_posR2,-y_pos3,w_rect_sub,h_rect_sub3, 'base','center');
