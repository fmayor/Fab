...
%% Make sine fishbones w/out electrodes
% N_fishbones = 1;
...
% ampl = [0.030*ones(1, 5), 0.024*ones(1,5)];
% period = 0.436*ones(1,N_fishbones);
% 
% device = {};
% 
...
% N_mirror = repmat([12 9 6 3 0], 1, 2);
% N_ramp_out = 10 * ones(1, N_fishbones);
% ampl = [0.100*ones(1, 5) 0.090*ones(1,5)];
% period = 0.436 *ones(1,N_fishbones);
% 
% device = {};
% curr_x = curr_x + P.write_field_x;
...
% curr_x = curr_x - P.wg_horz_spacing/2 + P.write_field_x/2;
