...
if param.isGenBB
    ...
    y_pad2 = y_pad1 - w_pad - d_wire2pad*2 - w_pad;
    
    w_pad3 = 260;
    
    y_pad3 = y_pad2 - w_pad /2 - w_pad3/2- d_wire2pad*2 - w_pad;
    ...
    rect_line1 = Rect(0, y_line1, w_total*1.2, w_wire,'base','center');
