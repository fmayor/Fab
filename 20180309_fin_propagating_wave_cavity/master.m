...
allLayers = {'SiLayer', 'NegLayer', 'HoleLayer', ...
    'HBSiProtectLayer', 'HBMetalGapLayer', 'HBMetalPosLayer', 'ExtentLayer','SpiralLayer','CurveLayer','GrtLayer','slotbox','MarkLayer'};
