function [LNPEZ_ZNB_X_Row, L_ZNBX] = genLNPEZ_ZNB_X_toprow_190109()
...
%% params for ZNB X
paramsZNBX1 = genParamStructs('scale_NB', [0.94:0.006:1.05],...
    'w_end', 0.26, 'tether_w2', [2.4],...
    'tether_L',[3.5],'tether_w_tether', [1],'w2',0.05,...
    'isGenBB',false, 'isGenPS',false,'theta',-90);

paramsZNBX2 = genParamStructs('L',[5,10,14,10,5,14],'d_nb2refl', [2.4,2.35,2.45],'L2',0,'g',0.3,...
    'w',0.45,'g_metal',0.15);
...
gaps = [0.16,0.18,0.25,0.27,0.3,0.4,0.5];
gaps = num2cell(repmat(gaps, 1, 40));
