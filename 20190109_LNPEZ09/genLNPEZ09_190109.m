...
isnoGC = true;
%% generate top row
 [LNPEZ_ZNB_Z_Row, L_NBZZ] = genLNPEZ_ZNB_X_toprow_190109();
 LNPEZ_ZNB_Z_Row.translate(0,1700);
 devMap.addelement(LNPEZ_ZNB_Z_Row);

%% generate bot row
 [LNPEZ_ZNB_Z_Row, L_NBZZ2] = genLNPEZ_ZNB_X_botrow_190109();
 LNPEZ_ZNB_Z_Row.translate(0,1700);
 LNPEZ_ZNB_Z_Row.rotate(180);
 devMap.addelement(LNPEZ_ZNB_Z_Row);

 %% generate mid row
 [CL_Row, L_ZZCL] = genLNPEZ_ZNB_X_midrow_190120(); %cantilever ZZ
...
dy = 1044;
% dm1 = Rect(0,0,w_DM, w_DM,'base','center');
pig = genPig_190114(35);
dm1=gpack.Group(0,0,{pig});
dm1.layer = 'M1_LD';
dm1.rotate(90);
dm2 = dm1.copy(); dm3 = dm1.copy(); dm4 = dm1.copy();
