classdef nanobeam_DS_EC_ZZ_X < gpack.Group
...
methods
    function obj = nanobeam_DS_EC_ZZ_X(varargin)
        obj@gpack.Group(0,0,{});
...
%         w_tetherArm = 30;   % mvoed to obj.P_tether as a parameter
        if obj.P_1DPS.isGen
            ...
            %attached to zigzag
            w_rect_sub=(obj.P_mirror.w+obj.P_mirror.amp-0.4*obj.P_mirror.gap)/2;
            ...
            h_rect_sub3=((round(obj.L/obj.P_mirror.a)+1.05)*obj.P_mirror.a*obj.scale_NB);
            y_pos3=h_rect_sub3/2+y_pos-h_rect_sub/2;%-w_tether/2-h_rect_sub/2;
            y_posL2 = y_pos3-h_rect_sub3/2+h_rect_sub2/2;
            
            rect_TLL = Rect(x_pos,y_pos3,w_rect_sub,h_rect_sub3, 'base','center');
            rect_TLL.layer = obj.layer_holes;
            rect_TLL2 = Rect(x_pos,y_posL2,w_rect_sub,h_rect_sub2, 'base','center');
            rect_TLL2.layer = obj.layer_medium; 
            rect_TLR = Rect(x_posR2,y_posR2,w_rect_sub,h_rect_sub, 'base','center');
            rect_TLR.layer = obj.layer_medium; 
            rect_TLR2 = Rect(x_posR2,y_posR2,w_rect_sub,h_rect_sub, 'base','center');
            ...
            rect_TRL2 = Rect(-x_posR2,y_posR2,w_rect_sub,h_rect_sub, 'base','center');
            ...
            rect_TRR2 = Rect(-x_pos,y_pos,w_rect_sub,h_rect_sub, 'base','center');
        ...
        rect_BLL = Rect(x_pos,-y_pos3,w_rect_sub,h_rect_sub3, 'base','center');%y_pos+w_tether+h_rect_sub
        rect_BLL.layer = obj.layer_holes; 
        rect_BLL2 = Rect(x_pos,-y_posL2,w_rect_sub,h_rect_sub2, 'base','center');
        rect_BLL2.layer = obj.layer_medium;
        rect_BLR = Rect(x_posR2,-y_posR2,w_rect_sub,h_rect_sub, 'base','center');
        rect_BLR.layer = obj.layer_medium; 
        rect_BLR2 = Rect(x_posR2,-y_posR2,w_rect_sub,h_rect_sub, 'base','center');
        ...
        rect_BRL2 = Rect(-x_posR2,-y_posR2,w_rect_sub,h_rect_sub, 'base','center');
        ...
        rect_BRR2 = Rect(-x_pos,-y_pos,w_rect_sub,h_rect_sub, 'base','center');
...
%         test2=Rect(port_B_BL(1),port_B_BL(2),10,'base','center');
%         test2.layer='metal_BB';
%         obj.addelement(test2);
%         test3=Rect(port_B_BR(1),port_B_BR(2),10,'base','center');
%         test3.layer='metal_BB';
%         obj.addelement(test3);
