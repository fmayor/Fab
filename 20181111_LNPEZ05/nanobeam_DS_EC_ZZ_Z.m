...
%         w_tetherArm = 30;   % mvoed to obj.P_tether as a parameter
        ...
        port_RL=zz_TL.elements{2}.port2+[zz_TL.x;zz_TL.y];
        port_RR=zz_TL.elements{3}.port2+[zz_TL.x;zz_TL.y];
        %right zigzag electrodes
        %param_elec.dy=6;
        param_elec.coeff_x=-13;
        param_elec.coeff_y=0;
        param_elec.coeff_x2=-6;
        param_elec.coeff_y2=-7;
        param_elec.w_pad=5;
        ...
        [small_R_elec,port_B_RL,port_B_RR]=genSmallAnchorElectrodes2(param_elec);
