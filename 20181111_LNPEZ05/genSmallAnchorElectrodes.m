function [dev,v_endEL,v_endER] = genSmallAnchorElectrodes(param)
    ...
    %p_EL = Polygon({v6,v7,v8,v9,v10,v11});
    ...
    v6=v1+[0;0.3];v7=v6+[0;-2];v8=v_endER;%v9=v8+[0;-zz_g_metal];
    v12=v8+[2*zz_g_metal;0];
    v10=v7+[zz_g_metal;zz_g_metal/2];v11=v6+[zz_g_metal;0];
    %p_ER = Polygon({v0,v1,v2,v3,v4});
    %p_ER = Wire({v1+[zz_g_metal/2;0.1],v_endER},zz_g_metal);
    p_ER = Polygon({v6,v7,v8,v12,v10,v11});
