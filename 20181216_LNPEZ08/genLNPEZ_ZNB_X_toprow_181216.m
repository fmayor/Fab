function [LNPEZ_ZNB_X_Row, L_ZNBX] = genLNPEZ_ZNB_X_toprow_181216()
...
paramsPEZ1 = genParamStructs('w_mid', [0.5,0.55,0.6,0.65],...
    'w_end', 0.26,...
     'g_mid', [0.2],'zz_w',[0.45],'g_metal',[0.15],...
...
%% params for ZNB X
paramsZNBX1 = genParamStructs('scale_NB', [0.89:0.006:1.0],...
    'w_end', 0.26, 'tether_w2', [2.4],...
    'tether_L',[3.5],'tether_w_tether', [1],'w2',0.05,...
    'isGenBB',false, 'isGenPS',false,'theta',-90);

paramsZNBX2 = genParamStructs('L',[5,10,14,10,5,14],'d_nb2refl', [2.1,2.2,2.3],'L2',0,'g',0.3,...
    'w',0.45,'g_metal',0.15);
...
gaps = [0.15,0.17,0.19,0.22,0.25,0.3,0.4];
gaps = num2cell(repmat(gaps, 1, 40));
