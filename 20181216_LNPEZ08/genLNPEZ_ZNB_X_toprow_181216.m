...
paramsNBZZ = genParamStructs('scale_NB', [1.0:0.0033:1.08],...
    ...
    'tether_L',[3.5],'tether_w_tether', [1],'w2',0.05,...
    'isGenBB',false);
params_ZZ = genParamStructs('d_nb2refl', [1.95, 2.05, 1.95, 2.05, 2.05, 1.95,2.05, 1.95],...
...
paramsZNBX2 = genParamStructs('L',[5,10,14,10,5,14],'d_nb2refl', [2.35,2.3,2.4],'L2',0,'g',0.3,...
    'w',0.45,'g_metal',0.15);
