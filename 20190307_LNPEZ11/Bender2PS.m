classdef Bender2PS < gpack.Group
   ...
   methods
       ...
       function addBender(obj)
           x_BenderRightEnd = -obj.get1DPSLength() + obj.P_1DPS.a/2 ;
       ...
       function addAnchor(obj)
           x_buff = 0.1;
           x_anchor =  -obj.get1DPSLength() + obj.P_1DPS.a/2 -...
       ...
       function addReleaseMask(obj)
           % left margin
           x_L =  -obj.get1DPSLength() + obj.P_1DPS.a/2 -...
               obj.P_bender.L;
           % right margin
           x_R = obj.w_RM;
