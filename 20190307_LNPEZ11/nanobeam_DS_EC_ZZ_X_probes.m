...
%         w_tetherArm = 30;   % mvoed to obj.P_tether as a parameter
        ...
        w_wire = 7;
        d2pad=10;
        v1=port_B_RL; v2=[xpad1/2;0]; v3 =[v2(1);-w_pad/2-d2pad];
        v4=[xpad2;v3(2)]; v5=[v4(1);0];
        w2=Wire({v1,v2,v3,v4,v5},w_wire);  %left right
        v1=port_B_RR; v2 = [xpad1;v1(2)];
        w1=Wire({v1,v2},w_wire); %left mid
        v1=port_B_RL+[0;param_elec.coeff_x3-param_elec.coeff_x];
        ...
        v1=port_B_BR; v2 = v1+[-10;-10]; v3=[v2(1);-w_pad/2-2*d2pad]; 
        v4=[xpad3;v3(2)]; v5=[v4(1);0];
        w4=Wire({v1,v2,v3,v4,v5},w_wire); %right mid
        v1=port_B_BL;v2=v1+[0;-45];v3=v2+[-8;0];
        v4=[v3(1);-w_pad/2-3*d2pad-w_wire/2];
        v5=[xpad3-h_pad/2-d2pad;v4(2)];v6=v5+[0;w_pad+3*d2pad+d2pad+w_wire/2];
        v7=[xpad2;v6(2)]; v8=[v7(1);0];
        w5=Wire({v1,v2,v3,v4,v5,v6,v7,v8},w_wire); %right right
