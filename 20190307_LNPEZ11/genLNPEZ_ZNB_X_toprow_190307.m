function [LNPEZ_ZNB_X_Row, L_ZNBX] = genLNPEZ_ZNB_X_toprow_190307()
...
%% params for ZNB X
paramsZNBX1 = genParamStructs('scale_NB', [0.93:0.00225:1.01],...
    'w_end', 0.26, 'tether_w2', [2.4],...
    'tether_L',[3.5],'tether_w_tether', [1],'w2',0.05,...
    'isGenBB',false, 'isGenPS',false,'theta',-90);

paramsZNBX2 = genParamStructs('gap',[0.28,0.35],'L',[4,9,12,15,18,22],'d_nb2refl', [2,2.1,2.2],'L2',0,'g',0.3,...
    'w',0.45,'g_metal',0.15);
